...
INTO Donation
    (DonationID, DonorID, CampaignID, DonationDate, DonationLocation, AmountDonated)
VALUES
    (91003, 9, 1003, '07-MAR-2022', '1996 Helena Point', '3500')
INTO Donation
    (DonationID, DonorID, CampaignID, DonationDate, DonationLocation, AmountDonated)
VALUES 
...
CREATED: Oct 31, 2022
AUTHOR:  Vy Vo and Thi Phan 
DESCRIPTION: Find the donor with the highest amount donated. Show donor first name, last name and the amount.

 Example: EXEC FindAmountDonated_sp
...
OPEN FD FOR
    ...
    SELECT      D.FirstName, D.LastName, DN.AmountDonated
    FROM        Donor D
    INNER JOIN  Donation DN
    ON          D.DonorID = DN.DonorID
